...
enum {
    ...
    RIDE_WET =                      0x00000100u,//see above
    ...
    RIDE_DISALLOW_ADJACENT_WALLS =  0x00010000u,
    RIDE_DISABLE_FIRST_TWO_OPERATING_MODES = 0x00020000u,
    RIDE_DISABLE_VEHICLE_IMPACTS =  0x00040000u,
...
enum {
    CAR_COAST_AND_FLY_OFF =           0x1u << 8,//ghost trains
    CAR_NO_UPSTOPS_TIGHT_TOLERANCE =  0x2u << 8,// max. -0.40 G
    CAR_NO_UPSTOPS =                  0x4u << 8,//bobsled-style max -0.45 G
    ...
    CAR_FLAG_MORE_SPIN_FRAMES =    0x4000u << 8,
    ...
    CAR_RIDERS_SCREAM =          0x100000u << 8,//riders can scream?
