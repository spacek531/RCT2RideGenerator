...
car_editor_t* car_editor_new()
{
    ...
    value_selector_add_selection(editor->running_sound_editor, "Train tracks",
        RUNNING_SOUND_TRAIN);
    value_selector_add_selection(editor->running_sound_editor, "Petrol engine",
    ...
    editor->animation_type_editor = value_selector_new("Animation type:");
    value_selector_add_selection(editor->animation_type_editor, "Steam locomotive",
        CAR_ANIMATION_MINITURE_RAILWAY_LOCOMOTIVE);
//    value_selector_add_selection(editor->animation_type_editor, "Swan boats",
//        CAR_ANIMATION_SWAN);
//    value_selector_add_selection(editor->animation_type_editor, "Canoes",
//        CAR_ANIMATION_CANOES);
//    value_selector_add_selection(editor->animation_type_editor, "Rowboats",
//        CAR_ANIMATION_ROW_BOATS);
//    value_selector_add_selection(editor->animation_type_editor, "Water tricycles",
//        CAR_ANIMATION_WATER_TRICYCLES);
//    value_selector_add_selection(editor->animation_type_editor, "Observation tower",
//        CAR_ANIMATION_OBSERVATION);
    value_selector_add_selection(editor->animation_type_editor, "Helicopter cars",
        CAR_ANIMATION_HELICARS);
    value_selector_add_selection(editor->animation_type_editor, "Monorail cycles",
        CAR_ANIMATION_MONORAIL_CYCLES);
//    value_selector_add_selection(editor->animation_type_editor, "4D coaster",
//        CAR_ANIMATION_MULTI_DIM_COASTER);

    editor->animation_speed_modifier = float_editor_new("Animation speed\nmodifier:",1/16,16);
    editor->steam_effect_modifier_X = float_editor_new("Steam spawn\nmodifier X:",-4,4);
    editor->steam_effect_modifier_Z = float_editor_new("Steam spawn\nmodifier Z:",-4,4);
    ...
    gtk_box_pack_start(GTK_BOX(editor->right_vbox), editor->animation_type_editor->container, FALSE, FALSE, 1);
    gtk_box_pack_start(GTK_BOX(editor->right_vbox), editor->animation_speed_modifier->container, FALSE, FALSE, 1);
    gtk_box_pack_start(GTK_BOX(editor->right_vbox), editor->steam_effect_modifier_X->container, FALSE, FALSE, 1);
    gtk_box_pack_start(GTK_BOX(editor->right_vbox), editor->steam_effect_modifier_Z->container, FALSE, FALSE, 1);
...
void car_editor_set_car(car_editor_t* editor, car_settings_t* car_settings)
{
    ...
    value_selector_set_value(editor->animation_type_editor, &(car_settings->animation_type));
    float_editor_set_float(editor->animation_speed_modifier, &(car_settings->animation_speed_modifier));
    float_editor_set_float(editor->steam_effect_modifier_X, &(car_settings->steam_effect_modifier[0]));
    float_editor_set_float(editor->steam_effect_modifier_Z, &(car_settings->steam_effect_modifier[1]));
}
